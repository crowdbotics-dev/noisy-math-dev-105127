"""
Django settings for noisy_math_dev_105127 project.
...
ROOT_URLCONF = 'noisy_math_dev_105127.urls'
...
WSGI_APPLICATION = 'noisy_math_dev_105127.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_math_dev_105127 API",
    "DESCRIPTION": "API documentation for noisy_math_dev_105127 App",
    "VERSION": "v1",
}
